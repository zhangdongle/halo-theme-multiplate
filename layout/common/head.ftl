...
<div class="header">
    <div class="container">
        <div class="flex-parent align-items-center">
            ...
            <button class="nav-icon-toggle d-lg-none" id="nav-icon-toggle" aria-label="Open side menu"><span class="nav-icon-toggle__box"><span class="nav-icon-toggle__inner"></span></span></button>
            <!-- end mobile toggle button -->
            <!-- Logo -->
            <div style="padding-top:10px;">
                    <img class="logo__img" src="${blog_logo!}" alt="logo" />
            </div>
            <!-- Search -->
            ...
            <#--  <div class="header__ad text-center d-lg-block d-none">
                <a href="#"><img src="${theme_base!}/source/images/placeholder_leaderboard.jpg" alt="" /></a>
            </div>  -->
        </div>
    </div>
</div>